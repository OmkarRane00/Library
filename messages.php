...
<body>
  ...
  <ul class="navbar-nav justify-content-end">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class0="dropdown-item" href="#">Question paper</a>
...
<?php
$sql = "SELECT `name`, `email`, `mobile`, `message`, `seen`, `sentdate` FROM `message` WHERE `Id` = '$mailid'";
$result = mysqli_query($conn, $sql);
  
  foreach ($result as $res) {
  }
?>
  <div class="rightblock mailblk1">
    <span class="mailsenderv">Sender : <span style="font-weight: bold;"><?php echo $res['name'];?></span></span>
    <br>
    <span class="mailemail">Email : <span style="font-weight: bold;"><?php echo $res['email'];?></span></span>
    <br>
    <span class="mailmobile">Mobile : <span style="font-weight: bold;"><?php echo $res['mobile'];?></span></span>
    <br>
    <span class="datetime">Date and Time : <span style="font-weight: bold;"><?php echo $res['sentdate'];?></span></span>
    <br><br>
    <span class="datetime" style="font-weight: bold;">Message : </span>
    <br>
    <br>
    <p style="font-size: 20px;">
      <?php echo $res['message'];
      $sql1 = "UPDATE `message` SET `seen`= 'y' WHERE `Id` = '$mailid'";
